...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Form Konfirmasi Data Pengiriman</h1>
            </div>
            <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <form id="quickForm" action="{{route('konfirmasi/beban/pengiriman/post',$data->id_penjualan)}}" method="POST">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-floating">
                                <label for="id_penjualan">Nama Barang</label>
